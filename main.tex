...
\item the first two moments of $Z_i$ and $\tau_i$ given $S_{i}$ and $S_{i+1}$, as well as the first moment of $Z_{i}$ and $\tau_i$ given $S_{i}$ and $S_{i+1}$, are finite and can be computed.
