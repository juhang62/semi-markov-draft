...
\item the dependence between variables are indicated by the graph in Figure \ref{fig:diagram}, particularly we need the Markov property $P(Z_i,\tau_i | \{ S_j \}_{j\le i} )=P(Z_i,\tau_i | S_{i-1}, S_i )$ and conditional independence $P(Z_i,Z_{i+1} | S_i) = P(Z_i | S_i) P(Z_{i+1} | S_i)$ and similarly for $\tau_i$.
\end{enumerate}
...
Second moment is less often studied in experimental studies. In Figure \ref{fig:M2},
