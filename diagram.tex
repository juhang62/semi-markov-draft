...
\node (Zm1) [var, above of=Sm1] {$Z_{i-1}$};
\node (tm1) [var, below of=Sm1] {$\tau_{i-1}$};


\node (S) [var, right of=Sm1] {$S_{i}$};
\node (Z) [var, above of=S] {$Z_{i}$};
\node (t) [var, below of=S] {$\tau_{i}$};

\node (Sp1) [var, right of=S] {$S_{i+1}$};
\node (Zp1) [var, above of=Sp1] {$Z_{i+1}$};
\node (tp1) [var, below of=Sp1] {$\tau_{i+1}$};


\node (Sp2) [var, right of=Sp1] {$S_{i+2}$};
\node (Zp2) [var, above of=Sp2] {$Z_{i+2}$};
